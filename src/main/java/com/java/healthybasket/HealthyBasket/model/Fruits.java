...
public class Fruits {
    ...
    public String toString(){
        return "Fruits [id=" + id + ", name=" + name + ", slogan=" + slogan + ", desc=" + description + ", price=" + price + ", weight=" + weight + ", quantity=" + quantity + ", lifetime=" + lifetime + ", healthBenefits=" + healthBenefits + ", date=" + date + "]";
    }
