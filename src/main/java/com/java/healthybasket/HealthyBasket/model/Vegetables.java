...
public class Vegetables {
    ...
    public String toString(){
        return "Vegetables [id=" + id + ", name=" + name + ", slogan=" + slogan + ", desc=" + description + ", price=" + price + ", weight=" + weight + ", quantity=" + quantity + ", lifetime=" + lifetime + ", healthBenefits=" + healthBenefits + ", type=" + type + ", date=" + date + "]";
    }
